...
rem                   set LOGGING_CONFIG="-Djava.util.logging.config.file=%CATALINA_BASE%\servers\conf\logging.properties"
rem
...
if not exist "%CATALINA_BASE%\servers\conf\logging.properties" goto noJuliConfig
...
set "SECURITY_POLICY_FILE=%CATALINA_BASE%\servers\conf\catalina.policy"
goto execCmd
